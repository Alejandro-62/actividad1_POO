...
horas_trabajadas = float(input("Ingrese el número de horas trabajadas: "))  # Permite al usuario ingresar las horas trabajadas
valor_hora = float(input("Ingrese el valor de la hora: "))  # Permite al usuario ingresar el valor por hora
retefuente = float(input("Ingrese el valor de la retefuente en números decimales, separado por un punto: "))  # Permite ingresar la retefuente como decimal
