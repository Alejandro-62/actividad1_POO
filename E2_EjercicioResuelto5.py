...
suma1=float(input("Añade el valor 1 de la suma: ")) #Ingreso primer valor de la operación
valorX=float(input("Añade el valor 2 de la suma: ")) #IngresO del segundo valor
valorY=float(input("Añade el valor 3 de la operación: ")) #IngresO del tercer valor
